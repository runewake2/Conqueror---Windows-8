    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame.Content == null)
            {
                ...
                bool hasAccount = (appData.RoamingSettings.Values.ContainsKey("username") && !String.IsNullOrEmpty(appData.RoamingSettings.Values["username"].ToString()));
                Type t = hasAccount ? typeof(MainPage) : typeof(LoginPage);
                if (!rootFrame.Navigate(t, e.Arguments))
                {
        ...
        protected override void OnWindowCreated(WindowCreatedEventArgs args)
        {
            SettingsPane.GetForCurrentView().CommandsRequested += (s, e) =>
            {
                ...
                SettingsCommand settingsCommand = new SettingsCommand("logout", "Log Out",
                    (handler) =>
                    {
                ...
                SettingsCommand defaultsCommand = new SettingsCommand("donate", "Donate",
                    (handler) =>
                    {
                        DonateFlyout sf = new DonateFlyout();
                        sf.Show();
                    });
